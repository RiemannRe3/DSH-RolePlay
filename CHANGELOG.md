...
- 在公开仓库提供四张 DSH RolePlay 演示卡的 Character Card V3 PNG 与 JSON。
- 补充每张卡的来源、改作关系、下载入口和 CC BY 4.0 内容许可证。
- 保持卡文件在 GitHub 仓库中独立下载，不将其打入 npm 插件包。

## 0.1.6 - 2026-08-30

- 重排公开 README，按角色卡、Persona、世界书、预设、上下文和卡内前端展示插件能力。
- 增加现代对话头图、Agent RolePlay 方向与 SillyTavern 兼容范围说明。
- 补全 Windows 安装、首次配置和插件启用、停用说明。
